...
public class JwtServiceImpl implements JwtService {
    ...
    public String generateToken(SecurityUser userDetails) {
        ...
        claims.put("first", userDetails.getFistName());
        claims.put("last", userDetails.getLastName());
    ...
    private String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder().setClaims(extraClaims).setSubject(userDetails.getUsername())
                ...
                //.setExpiration(new Date(System.currentTimeMillis() + 1000 * 1000 * 60 * 24)) never expire
